...
2. HACS (Home Assistant Community Store) installed (optional, but recommended).
3. Your Force H3X Inverter/Hub connected to your local network (LAN/WLAN).
4. Static IP assigned to your Solar Hub via your router.
...
5. Find Solar Hub Modbus in HACS and click Download.
